                        ...
                        <div class="row ls_divider">
                            <div class="col">
                                <label class=" control-label">علامة المفرادات والمعاني:* </label>
                                    <input type="number" onchange="setTwoNumberDecimal2(this)" step="any"  max="100" min="0" value="{{old("writing")!=null?old("writing"):''}}" class="form-control text-input" id="writing"
                                ...
                                <label class=" control-label">علامة القراءة والتحليل:* </label>
                                    <input type="number" onchange="setTwoNumberDecimal2(this)" step="any" min="0" value="{{old("reading")!=null?old("reading"):''}}" class="form-control text-input" id="reading"
                        ...
                        <div class="row ls_divider">
                            <div class="col">
                                <label class=" control-label">علامة القواعد والتراكيب:* </label>
                                    <input type="number" onchange="setTwoNumberDecimal2(this)" step="any" min="0" value="{{old("grammer")!=null?old("grammer"):''}}" class="form-control text-input" id="grammer"
                               ...
                               <div class="col">
                                <label class=" control-label">علامة الشفوي:* </label>
                                    <input type="number" onchange="setTwoNumberDecimal2(this)" step="any" min="0" value="{{old("conversation")!=null?old("conversation"):''}}" class="form-control text-input" id="conversation"
