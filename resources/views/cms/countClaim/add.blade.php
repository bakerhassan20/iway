...
<div class="row">
    <div class="col-lg-10 col-md-12" >
        <div class="card">
            <div class="card-body">
                     <form id="formID" class="formular form-horizontal ls_form" method="post" action="/CMS/add/CountClaim/{{$item->id}}">
                        @csrf
                        <div class="row">
                            <div class="col-10">
                                <label class="control-label">اسم الطالب:* </label>
                                    ...
                                    <input type="hidden" value="{{$item->id}}" name="collection_fees_id_h" id="collection_fees_id_h">
