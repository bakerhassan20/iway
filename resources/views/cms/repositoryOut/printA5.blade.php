...
<html>
  ...
  <body>
    ...
    <p style="font-size:23px; text-align: center" >صرف مستودع</p><br>
    <div class="row"style="line-height: 1.5;font-size: 14px;color: #4a4a4a;">
              ...
              border-radius: 3px;">
                ...
                <tr>
                    <td>القسم: </td>
                    <td style="text-align: left;">{{\App\Models\Repository::find($item->repository_id)->name}}</td>
                  </tr>
                  <tr>
                    <td> البيان: </td>
                    <td style="text-align: left;">{{$item->statement}}</td>
                  </tr>
