   ...
   صرف خصم 
    ...
    <div class="row"style="line-height: 1.5;font-size: 14px;color: #4a4a4a;">
              ...
              border-radius: 3px;">
                ...
                <tr>
                    <td> النوع: </td>
                    <td style="text-align: left;"> @if($item->type == 0)صرف مكافأة @else صرف خصم @endif</td>
                  </tr>
                    <tr>
                    <td> من شهر: </td>
                    <td style="text-align: left;">{{$item->receipts_rewards}}</td>
                  </tr>

                    <tr>
                    <td> السبب: </td>
                    <td style="text-align: left;">{{\App\Models\Option::find($item->reason)->title}}</td>
                  </tr>
