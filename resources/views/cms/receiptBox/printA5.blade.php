...
<html>
  ...
  <body>
    ...
    <p style="font-size:23px; text-align: center" >صرف صندوق</p><br>
    <div class="row"style="line-height: 1.5;font-size: 14px;color: #4a4a4a;">
              ...
              border-radius: 3px;">
                ...
                <tr>
                    <td> اسم المصروف: </td>
                    <td style="text-align: left;">{{\App\Models\Box_expense::find($item->type)->name}}</td>
                  </tr>
                    <tr>
                    <td>العميل: </td>
