                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    ...
                    <div class="row mg-b-20">
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            ...
                            <input class="form-control form-control-sm mg-b-20" data-parsley-class-handler="#lnWrapper" autocomplete="false"readonly onfocus="this.removeAttribute('readonly');"
                    ...
                    <div class="row mg-b-20">
                        <div class="col-xs-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::select('roles_name[]', $roles,[], array('class' => 'form-control form-control-lg select2','multiple')) !!}
                            </div>
                        </div>
                    </div>
                       ...
                       <div class="col-lg-6">
                            <label class="form-label">مستخدم مسؤول</label>
