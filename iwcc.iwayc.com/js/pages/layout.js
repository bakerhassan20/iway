...
var $navigationControl=$(".Link-control");
...
jQuery(document).ready(function(a){
    ...
    minimize_left_Link_hover_Display();
    right_box_display();
    phone_nav_control();
...
function minimize_left_Link_hover_Display(){
...
function dropDownLinkControl(){
    $("ul.mainNav li").children("ul").removeAttr("style")
}
function changeLinkSizeTriger(){
