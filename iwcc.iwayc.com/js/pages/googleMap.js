...
function direction_go_map(){
    ...
    $("#direction").goMap({
        ...
        icon: '{{ asset('') }}images/icons/office-i-32.png',
        addMarker: 'single',
...
function find_location_go_map(){
    ...
    $("#findLocation").goMap({
        ...
        icon: '{{ asset('') }}images/icons/gmapsingle-i-32.png',
        addMarker: 'single',
        disableDoubleClickZoom: true,
        zoom: 14
    });
...
function branch_locator_go_map(){
    ...
    var $branch = $("#branch").goMap({
        ...
        markers: [{
            ...
            title: 'Home',
            icon: '{{ asset('') }}images/icons/home-i-32.png'
        },{
            address:"sydney, australia",
            draggable: false,
            icon: '{{ asset('') }}images/icons/shop-i-32.png',
            html: {
                content: 'Show Room',
                popup:false
            }
            ...
            address:"Peru",
            draggable: true,
            icon: '{{ asset('') }}images/icons/factory-i-32.png',
            html: {
                content: 'Industry',
                popup:false
            }
