...
(/** @lends <global> */function (window, document, $, undefined) {
	 ...
	 *    } );
        ...
        function _fnFeatureHtmlLength(settings) {
            var
                ...
                Link = settings.aLengthLink,
                d2 = $.isArray(Link[0]),
                lengths = d2 ? Link[0] : Link,
                language = d2 ? Link[1] : Link;
            ...
            // This split doesn't matter where _Link_ is, we get three items back from it
            var a = settings.oLanguage.sLengthLink.split(/(_Link_)/);
            div.children()
                .append(a[0])
                .append(select)
                .append(a[2]);
		 ...
		 *    } );
            ...
            this.each(function () {
                ...
                // If the length Link is given, but the init display length is not, use the length Link
                if (oInit.aLengthLink && !oInit.iDisplayLength) {
                    oInit.iDisplayLength = $.isArray(oInit.aLengthLink[0]) ?
                        oInit.aLengthLink[0][0] : oInit.aLengthLink[0];
                }
	 ...
	 *    } );
		 ...
		 *   } );
             ...
             * down Link that DataTables shows when pagination is enabled. It can be
             ...
             *
             *  @dtopt Option
             *  @name DataTable.defaults.lengthLink
             *
             *  @example
             *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "lengthLink": [[10, 25, 50, -1], [10, 25, 50, "All"]]
		 *      } );
		 *    } );
             */
            "aLengthLink": [ 10, 25, 50, 100 ],
		 ...
		 *    } );
             ...
             * Link (sizes are 10, 25, 50 and 100). Requires pagination (`paginate`).
             *  @type boolean
             *  @default true
             *
             *  @dtopt Features
		 ...
		 *    } );
             ...
             * this to a custom setting using a pop-up Link.
             *  @type int
             *  @default 10
             *
             *  @dtopt Options
		 ...
		 *    } );
			 ...
			 *    } );
                ...
                /**
                 * Detail the action that will be taken when the drop down Link for the
                 * pagination length option is changed. The '_Link_' variable is replaced
                 * with a default select list of 10, 25, 50 and 100, and can be replaced
                 * with a custom select box if required.
                 *  @type string
                 *  @default Show _Link_ entries
                 *
                 *  @dtopt Language
                 *  @name DataTable.defaults.language.lengthLink
                 *
                 *  @example
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "lengthLink": "Display _Link_ records"
			 *        }
			 *      } );
			 *    } );
                 *
			 ...
			 *    } );
                 */
                "sLengthLink": "Show _Link_ entries",
        ...
        DataTable.models.oSettings = {
            ...
            /**
             * List of options that can be used for the user selectable length Link.
             * Note that this parameter will be set by the initialisation routine. To
             * set a default use {@link DataTable.defaults}.
             *  @type array
             *  @default []
