...
!function (a, b) {
    ...
    var Y = /^(?:input|select|textarea)$/i, Z = /^key/, $ = /^(?:mouse|contextLink)|click/, _ = /^(?:focusinfocus|focusoutblur)$/, ab = /^([^.]*)(?:\.(.+)|)$/;
    ...
    n.fn.extend({addClass: function (a) {
        ...
        return!1
    }}), n.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextLink".split(" "), function (a, b) {
        n.fn[b] = function (a, c) {
